...
[版本化组装决策](../../../../docs/decisions/20260913-desktop-versioned-assembly.zh.md) 将此归属规则延伸到实际交付：官方运行时字节保持原样，Mint 扩展具有独立的 tarball 身份。原生外壳验证组装文件，并通过 DSH 公开 API 初始化自己的自定义 profile。
