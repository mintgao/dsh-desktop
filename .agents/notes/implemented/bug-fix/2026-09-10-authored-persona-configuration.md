...
Tests cover actual delivered-baseline authored copy, target new-session/restart persona semantics and logged system content, unchanged files, and complete baseline recovery. Parser, scoped-disposal, non-Mint packed resolution, catalog and keyless snapshot checks accompany the implementation.
