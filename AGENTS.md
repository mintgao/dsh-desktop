...
- **Mint work uses [dsh-mint-client-feature](.agents/skills/dsh-mint-client-feature/SKILL.md).** `desktop-mint` owns DSH plugin selection/defaults; Electron owns native lifecycle.
