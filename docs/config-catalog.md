...
Requires: `channels` · `storageDomain` · `agents` · `agentDefaultModel` · `agentPresets` · `permissionPresets` · `workspaceRegistry`
...
Source: [`packages/channel/channel-session/src/index.ts:79`](../packages/channel/channel-session/src/index.ts)
...
Source: [`packages/client/ui-session-notifications/src/index.ts:20`](../packages/client/ui-session-notifications/src/index.ts)
...
Source: [`packages/preset/persona/src/index.ts:42`](../packages/preset/persona/src/index.ts)
