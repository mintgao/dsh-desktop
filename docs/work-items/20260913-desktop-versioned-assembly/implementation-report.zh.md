...
本地应用为 `apps/desktop-mint/dist/mac-arm64/DSH Desktop.app`。运行时清单摘要为 `5905bcfcb749533c936a0e9baa03ec3e882e7a786a701fcecdd892a13a847acc`；`Contents/Resources/app.asar` SHA256 为 `469881e6f1a185d3a1cad75e2eef7d91b1130c82e66055cd53d058d6b6a31f53`。暂存与打包组装凭据的 SHA256 均为 `52429c42995c1b7e14b11865acb2d7332d98483b78bf9f19dc482489768c8b2d`。

外壳源码摘要为 `2cfbcfff40f44d037b04388f20978924675f6fbeb1b402de9cd1e637d020e340`。官方锁摘要为 `afa439f37a8b544b3884460a10634c6b474736958942aa4543ea048a95d348df`；描述符摘要为 `9157bc2a957d3bd51c93b41d5747b6a28226099de3ef215d530e2030295f9aa0`。运行时与外壳源码版本均为 `0.1.5-rc.2`；分别标识的 Mint 包版本仍为 `0.1.5-alpha.2`，凭据包含精确 tarball 完整性。
