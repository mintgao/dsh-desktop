...
(async()=>{
 ...
 console.log(JSON.stringify({scope:'Actual CLI module evaluated with controlled import dependencies; no live staging, native launch, filesystem/process cleanup proof',results:[passed,denied,cleanup,changed,pending]},null,2));
