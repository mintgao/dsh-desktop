...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-session-notifications': { kind: 'none', reason: 'Browser-side system-notification presentation; registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-mint': { kind: 'none', reason: 'The product Bundle currently selects only browser-side system UI.' },
